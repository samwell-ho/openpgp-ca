...
`openpgp-ca user import -n "Alice User" -e alice@example.org --key-file alice.pubkey --revocation-file alice-revocation.asc`
...
`openpgp-ca user add -e alice@example.org -n "Alice User"`
...
`openpgp-ca user add -e alice@some.org -n "Alice"`
...
`openpgp-ca user add -e bob@other.org -n "Bob"`
...
`openpgp-ca user add -e carol@third.org -n "Carol"`
